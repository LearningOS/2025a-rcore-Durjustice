...
impl DiskInode {
    ...
    /// Get link count of this inode
    pub fn get_link_count(&self) -> u32 {
        self.link_count
    }
    /// Increase link count of this inode
    pub fn inc_link_count(&mut self) {
        self.link_count += 1;
    }
    /// Decrease link count of this inode
    pub fn dec_link_count(&mut self) {
